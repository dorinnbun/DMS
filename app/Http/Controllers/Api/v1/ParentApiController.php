...
class ParentApiController extends Controller
{
  ...
  public function dataTable(Request $request, $query = null): JsonResponse
  {
    ...
    return $this->response_json($response_data, "successfully get user");
  ...
  public function response_json($data, $msg, $code = "200", $description = "")
  {
    ...
    return $rsp
      ->setStatus($code)
      ->setCode($code)
      ->setMessage(isset($msg) ? $msg : "Successfully")
      ->setStatusDescription(isset($description) ? $description : "Successfully")
      ->toApiResponse();
  }
