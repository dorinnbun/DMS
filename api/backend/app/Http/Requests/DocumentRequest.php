...
class DocumentRequest extends BaseRequest // FormRequest
{
  ...
  public function rules(): array
  {
    $rules = [
      ...
      "formTemplate"                => "required|mimes:jpeg,png,jpg,pdf|max:2048",
      "formTemplate1"               => "nullable|mimes:jpeg,png,jpg,pdf|max:2048",
      "formTemplate2"               => "nullable|mimes:jpeg,png,jpg,pdf|max:2048",
    ];
