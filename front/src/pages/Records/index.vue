  ...
  export default {
    data: () => ({
      ...
      fingerPrintsFileInput: [
        ...
        { key: "rightMiddlePrint", label: "ម្រាមកណ្តាលដៃស្តាំ",  type  : "file", value: "", name: "right_middle_print", required: false },
        ...
        { key: "leftMiddlePrint", label : "ម្រាមកណ្តាលដៃឆ្វេង",  type  : "file", value: "", name: "left_middle_print", required: false },
