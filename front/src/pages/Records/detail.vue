...
export default {
  data: () => ({
    ...
    personalInfoInputFields: [{
      ...
      type: "date",
      col: 6,
      value: "សង្កាត់បឹងកេងកង ខណ្ឌចំការមន រាជធានីភ្នំពេញ"
    },
    {
      key: "ethnicity",
      label: "ជនជាតិ",
    ...
    fingerPrintsFileInput: [
      ...
      { key: "right_middle_print", label: "ម្រាមកណ្តាលដៃស្តាំ", type: "file", value: "../../../public/finger-print.jpg" },
      ...
      { key: "left_middle_print", label: "ម្រាមកណ្តាលដៃឆ្វេង", type: "file", value: "../../../public/finger-print.jpg" },
